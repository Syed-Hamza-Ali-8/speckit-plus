...
import type { ActionTaken } from '@/types/chat';

export interface ActionChipProps extends HTMLAttributes<HTMLDivElement> {
  action: ActionTaken;
}
...
/**
 * ActionChip - Badge showing an executed tool action
 */
const ActionChip = forwardRef<HTMLDivElement, ActionChipProps>(
